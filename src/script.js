...
const tick = () => {
    ...
    sphere.rotation.y += .5 * (targetX - sphere.rotation.y) //mouse position to rotation
    sphere.rotation.x += .05 * (targetY - sphere.rotation.x) //mouse position to rotation
    sphere.position.z += .05 * (targetY - sphere.rotation.x) //mouse position to position
